            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.store') }}">
                        ...
                        <div class="row mb-3">
                            <label for="password_confirmation" class="col-12 col-md-4 col-form-label">Confirm Password</label>
                            <div class="col-12 col-md-6">
                        ...
                        <div class="row mb-3">
                            <div class="col-12 col-md-6 offset-md-4">
                                ...
                                <a href="{{ route('users.index') }}" class="btn btn-secondary w-100 w-md-auto">
                                    Cancel
                                </a>
                            </div>
                        </div>
